...
public class ModCriteria {
    ...
    public static final MilkCreeperCriterion MILK_CREEPER = Criteria.register(Identifier.of(ModRegistry.MOD_ID, "milk_creeper").toString(), new MilkCreeperCriterion());
